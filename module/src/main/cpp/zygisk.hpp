...
struct module_abi {
    ...
    module_abi(ModuleBase *module) : api_version(ZYGISK_API_VERSION), _this(module) {
        preAppSpecialize = [](ModuleBase * self, AppSpecializeArgs * args) { self->preAppSpecialize(args); };
        postAppSpecialize = [](ModuleBase * self, const AppSpecializeArgs * args) { self->postAppSpecialize(args); };
        preServerSpecialize = [](ModuleBase * self, ServerSpecializeArgs * args) { self->preServerSpecialize(args); };
        postServerSpecialize = [](ModuleBase * self, const ServerSpecializeArgs * args) { self->postServerSpecialize(args); };
    }
};
